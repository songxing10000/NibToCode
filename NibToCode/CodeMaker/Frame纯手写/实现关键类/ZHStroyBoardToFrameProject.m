...
@interface ZHStroyBoardToFrameProject ()
...
@implementation ZHStroyBoardToFrameProject
...
- (void)transformProjectToFrameProject:(NSString *)projectPath{
        ...
        if(dic[@"customClass"]!=nil){
            viewController=dic[@"customClass"];
            {
                ...
                for (NSString *idStr in views) {
                    ...
                    //NSLog(@"self.idAndViewPropertys.count=%ld",self.idAndViewPropertys.count);
                    //创建约束
                    NSString *constraintCode=[ZHStoryboardTextManagerToFrameMVC getCreatConstraintCodeWithIdStr:idStr WithViewName:self.customAndId[idStr] withConstraintDic:viewConstraintDicM_Self_NEW withSelfConstraintDic:originalConstraintDicM_Self withOutletView:self.idAndOutletViews isCell:NO withDoneArrM:brotherOrderArrM withCustomAndNameDic:self.customAndName addToFatherView:fatherView isOnlyTableViewOrCollectionView:NO withIdAndOutletViewsDic:self.idAndOutletViews withProperty:self.idAndViewPropertys[idStr] replaceLayoutsDicM:replaceLayoutsDicM doneViewArrM:doneViewArrM viewsFrameDicM:viewsFrameDicM omissionsFrameViews:omissionsFrameViews];
...
- (void)detailSubCells:(NSArray *)subCells andXMLHandel:(ReadXML *)xml withFatherViewController:(NSString *)viewController{
    for (NSDictionary *subDic in subCells) {
        ...
        for (NSString *idStr in views) {
            ...
            //创建约束
            NSString *constraintCode=[ZHStoryboardTextManagerToFrameMVC getCreatConstraintCodeWithIdStr:idStr WithViewName:self.customAndId[idStr] withConstraintDic:viewConstraintDicM_Self_NEW withSelfConstraintDic:originalConstraintDicM_Self withOutletView:self.idAndOutletViews isCell:YES withDoneArrM:brotherOrderArrM withCustomAndNameDic:self.customAndName addToFatherView:fatherView isOnlyTableViewOrCollectionView:NO withIdAndOutletViewsDic:self.idAndOutletViews withProperty:self.idAndViewPropertys[idStr] replaceLayoutsDicM:replaceLayoutsDicM doneViewArrM:doneViewArrM viewsFrameDicM:viewsFrameDicM omissionsFrameViews:omissionsFrameViews];

...
//    @"text",@"textAlignment",@"adjustsFontSizeToFit",@"numberOfLines",@"pointSize"
    ...
    if (property.textColor_red.length>0||property.textColor_green.length>0||property.textColor_blue.length>0) {
        if(![property.textColor_red isEqualToString:@"0.0"] &&
           ![property.textColor_green isEqualToString:@"0.0"] &&
           ![property.textColor_blue isEqualToString:@"0.0"]){
            ...
            CGFloat redValue =
            [self getThreedigits:property.textColor_red].doubleValue;
            CGFloat greenValue =
            [self getThreedigits:property.textColor_green].doubleValue;
            CGFloat blueValue =
            [self getThreedigits:property.textColor_blue].doubleValue;
            CGFloat alphaValue =
            property.textColor_alpha.doubleValue;
            
            NSLog(@"----%@---", [self hexFromUIColorRedValue:redValue greenValue:greenValue blueValue:blueValue alphaValue:alphaValue]);
        }
    }
}
...
+ (NSString *) hexFromUIColorRedValue: (CGFloat) red greenValue:(CGFloat)green blueValue:(CGFloat)blue alphaValue:(CGFloat)alpha {
...
//    }
    ...
    if (CGColorSpaceGetModel(CGColorGetColorSpace(cgColor)) != kCGColorSpaceModelRGB) {
        return [NSString stringWithFormat:@"0xFFFFFF"];
    }
#warning 加1问题
    return [NSString stringWithFormat:@"0x%02X%02X%02X",
            (int)((CGColorGetComponents(cgColor))[0]*255.0),
            (int)((CGColorGetComponents(cgColor))[1]*255.0),
            (int)((CGColorGetComponents(cgColor))[2]*255.0)];
}
@end
